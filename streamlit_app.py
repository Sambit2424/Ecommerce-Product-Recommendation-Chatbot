# To convert our Flask application to Streamlit, we can simplify the architecture by removing manual routing 
# and utilizing Streamlit's built-in session state for memory management. Kindly note that this practice is not recommended
# for deploying app in production and the general way of using a frontend folder(index.html,style.css) is better. 
# This is just to check out a different method of deployment using streamlit UI
